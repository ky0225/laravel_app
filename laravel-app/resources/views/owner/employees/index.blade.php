					...
					<section class="text-gray-600 body-font">
						<div class="container md:px-5 mx-auto">
							...
							<div class="flex justify-end mb-4">
								<button onclick="location.href='{{ route('owner.employees.create') }}'" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録する</button>
							</div>
